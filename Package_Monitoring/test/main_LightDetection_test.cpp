...
struct top_out: public out_port<int>{}; 
...
int main(){
	...
	const char * i_input_data = "../input_data/LightDetection_input_test.txt"; 
	...
	submodels_TOP = {input_reader, ld1};
	...
	eocs_TOP = {  
		dynamic::translate::make_EOC<LightDetection_defs::outO,top_out>("ld1")
	}; 
	
	dynamic::modeling::ICs ics_TOP; 
	ics_TOP = { 
		dynamic::translate::make_IC<iestream_input_defs<int>::out,LightDetection_defs::inL>( "input_reader","ld1") 
	}; 
	...
	/***** (6) *****/ 
	/*************** Loggers *******************/ 
	static ofstream out_messages("../simulation_results/LightDetection_test_output_messages.txt"); 
	...
	static ofstream out_state("../simulation_results/LightDetection_test_output_state.txt"); 
